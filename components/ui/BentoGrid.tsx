...
export const BentoGridItem = ({
  ...
  const leftLists = ["JavaScript", "NodeJS", "Express"];
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("shahzadmudassir957@gmail.com");
    setCopied(true);
  };
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2 mr-2">
