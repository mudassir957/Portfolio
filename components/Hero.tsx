    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h2 className="uppercase tracking-widest text-xl text-center text-blue-200 max-w-80">
            Your Vision, My Code
          </h2>

          <TextGenerateEffect
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
            words="Turning Ideas into the Interactive Experiences"
          />
          <p className="text-center md:tracking-wider mb-4 text-md md:text-lg lg:text-2xl">
            Hi, I&apos;m{" "}
            <span className="tracking-widest text-xl lg:text-3xl text-purple">
              Mudassir Shehzad
            </span>
